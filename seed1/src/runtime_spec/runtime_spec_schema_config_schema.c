    ...
    runtime_spec_schema_config_schema_hooks *make_runtime_spec_schema_config_schema_hooks(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    {
      if (strcmp(tree->u.object.keys[i], "prestart") && strcmp(tree->u.object.keys[i], "createRuntime") && strcmp(tree->u.object.keys[i], "createContainer") && strcmp(tree->u.object.keys[i], "startContainer") && strcmp(tree->u.object.keys[i], "poststart") && strcmp(tree->u.object.keys[i], "poststop"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
    ...
    runtime_spec_schema_config_schema_root *make_runtime_spec_schema_config_schema_root(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "path") && strcmp(tree->u.object.keys[i], "readonly"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process_console_size *make_runtime_spec_schema_config_schema_process_console_size(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "height") && strcmp(tree->u.object.keys[i], "width"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process_user *make_runtime_spec_schema_config_schema_process_user(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "uid") && strcmp(tree->u.object.keys[i], "gid") && strcmp(tree->u.object.keys[i], "umask") && strcmp(tree->u.object.keys[i], "additionalGids") && strcmp(tree->u.object.keys[i], "username"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process_capabilities *make_runtime_spec_schema_config_schema_process_capabilities(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "bounding") && strcmp(tree->u.object.keys[i], "permitted") && strcmp(tree->u.object.keys[i], "effective") && strcmp(tree->u.object.keys[i], "inheritable") && strcmp(tree->u.object.keys[i], "ambient"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process_io_priority *make_runtime_spec_schema_config_schema_process_io_priority(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "class") && strcmp(tree->u.object.keys[i], "priority"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process_scheduler *make_runtime_spec_schema_config_schema_process_scheduler(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "policy") && strcmp(tree->u.object.keys[i], "nice") && strcmp(tree->u.object.keys[i], "priority") && strcmp(tree->u.object.keys[i], "flags") && strcmp(tree->u.object.keys[i], "runtime") && strcmp(tree->u.object.keys[i], "deadline") && strcmp(tree->u.object.keys[i], "period"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema_process *make_runtime_spec_schema_config_schema_process(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "args") && strcmp(tree->u.object.keys[i], "commandLine") && strcmp(tree->u.object.keys[i], "consoleSize") && strcmp(tree->u.object.keys[i], "cwd") && strcmp(tree->u.object.keys[i], "env") && strcmp(tree->u.object.keys[i], "terminal") && strcmp(tree->u.object.keys[i], "user") && strcmp(tree->u.object.keys[i], "capabilities") && strcmp(tree->u.object.keys[i], "apparmorProfile") && strcmp(tree->u.object.keys[i], "oomScoreAdj") && strcmp(tree->u.object.keys[i], "selinuxLabel") && strcmp(tree->u.object.keys[i], "ioPriority") && strcmp(tree->u.object.keys[i], "noNewPrivileges") && strcmp(tree->u.object.keys[i], "scheduler") && strcmp(tree->u.object.keys[i], "rlimits"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
    ...
    runtime_spec_schema_config_schema *make_runtime_spec_schema_config_schema(yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
  ...
  *err = NULL;
  ...
  if (tree->type == yajl_t_object)
  {
    ...
    for (i = 0; i < tree->u.object.len; i++)
    {
      if (strcmp(tree->u.object.keys[i], "ociVersion") && strcmp(tree->u.object.keys[i], "hooks") && strcmp(tree->u.object.keys[i], "annotations") && strcmp(tree->u.object.keys[i], "hostname") && strcmp(tree->u.object.keys[i], "domainname") && strcmp(tree->u.object.keys[i], "mounts") && strcmp(tree->u.object.keys[i], "root") && strcmp(tree->u.object.keys[i], "process") && strcmp(tree->u.object.keys[i], "linux") && strcmp(tree->u.object.keys[i], "solaris") && strcmp(tree->u.object.keys[i], "windows") && strcmp(tree->u.object.keys[i], "vm") && strcmp(tree->u.object.keys[i], "zos"))
      {
        if (ctx->options & OPT_PARSE_FULLKEY)
        {
          resi->u.object.keys[j] = tree->u.object.keys[i];
