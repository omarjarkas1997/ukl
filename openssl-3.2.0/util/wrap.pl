...
BEGIN {
    ...
    require '/home/omarjarkas/Desktop/SEED/seed_project/ukl/openssl-3.2.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/omarjarkas/Desktop/SEED/seed_project/ukl/openssl-3.2.0/test/fips-and-base.cnf';
    shift;
