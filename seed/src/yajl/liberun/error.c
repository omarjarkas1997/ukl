...
int libcrun_init_logging (crun_output_handler *new_output_handler, void **new_output_handler_arg, const char *id,
...
void
log_write_to_stderr (int errno_, const char *msg, bool warning, void *arg_unused)
{
    (void) errno_;
    (void) msg;
    (void) warning;
    (void) arg_unused; // Use (void) to explicitly mark the argument as unused
    log_write_to_stream (errno_, msg, warning, stderr);
}

void
log_write_to_syslog (int errno_, const char *msg, bool warning, void *arg_unused)
{
    (void) errno_;
    (void) msg;
    (void) warning;
...
void log_write_to_journald (int errno_, const char *msg, bool warning, void *arg_unused)
{
    (void) errno_;
    (void) msg;
    (void) warning;
