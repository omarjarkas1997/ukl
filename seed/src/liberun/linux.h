...
#ifndef SEED3_LINUX_H
#define SEED3_LINUX_H
...
static inline int syscall_clone (unsigned long flags, void *child_stack) {
...
static inline bool container_has_intelrdt (libcrun_container_t *container) {
