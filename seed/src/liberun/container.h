...
#ifndef SEED3_CONTAINER_H
#define SEED3_CONTAINER_H
...
int libcrun_container_kill (libcrun_context_t *context, const char *id, const char *signal,
                                           libcrun_error_t *err);

int libcrun_container_killall (libcrun_context_t *context, const char *id, const char *signal,
                                              libcrun_error_t *err);
...
int libcrun_container_exec_with_options (libcrun_context_t *context, const char *id,
...
int libcrun_container_update_intel_rdt (libcrun_context_t *context, const char *id,
                                                       struct libcrun_intel_rdt_update *update, libcrun_error_t *err);

int libcrun_container_get_features (libcrun_context_t *context, struct features_info_s **info,
                                                   libcrun_error_t *err);
...
int libcrun_container_read_pids (libcrun_context_t *context, const char *id, bool recurse, pid_t **pids, libcrun_error_t *err);

int libcrun_write_json_containers_list (libcrun_context_t *context, FILE *out, libcrun_error_t *err);

void get_root_in_the_userns (runtime_spec_schema_config_schema *def, uid_t host_uid, gid_t host_gid,
                             uid_t *uid, gid_t *gid);

static inline void cleanup_containerp (libcrun_container_t **c) {
